...
**Project**: voice-capture-magic 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: a tool that can record my voice  
...
```sh
git clone https://github.com/GPT-Engineer-App/voice-capture-magic.git
cd voice-capture-magic
npm i
